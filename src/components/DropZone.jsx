...
export default function DropZone({ onFile, disabled }) {
  ...
  return (
    <div
      ...
      style={{ borderColor: dragging ? '#e8ff47' : 'var(--border)', background: 'var(--surface)' }}
    >
      <input
        ref={inputRef}
        type="file"
      ...
      <div className="flex justify-center mb-4">
        {fileName ? (
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(232,255,71,0.1)', border: '1px solid rgba(232,255,71,0.2)' }}>
            <FileAudio size={24} style={{ color: '#e8ff47' }} />
          </div>
        ) : (
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(232,255,71,0.06)', border: '1px solid var(--border)' }}>
